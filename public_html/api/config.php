...
define('DB_NAME', 'u123456789_ufuturo'); // Altere para o nome da sua base de dados
define('DB_USER', 'u123456789_ufuturo'); // Altere para o seu utilizador
define('DB_PASS', 'SuaPasswordSegura123!'); // Altere para a sua palavra-passe
